					...
					Toast.makeText(getApplicationContext(), mCountries[position], Toast.LENGTH_LONG).show();
					 ...
					 Intent intent = null;
		                switch (position) {
		                    ...
		                    case 0:
		                        //Inicio
		                    	 intent =  new Intent(App14Activity.this, MainActivity.class);
		                    ...
		                    case 1:
		                        ...
		                        intent =  new Intent(App14Activity.this, App2Activity.class);
		                        startActivity(intent);
		                        finish();
		                        break;
		                    ...
		                    case 2:
		                    	...
		                    	intent =  new Intent(App14Activity.this, App9Activity.class);
		                    	startActivity(intent);
		                        finish();
		                        break;
